...
This chart installs [argo-cd](https://argo-cd.readthedocs.io/en/stable/), a declarative, GitOps continuous delivery tool for Kubernetes.
...
| controller.metrics.enabled | bool | `true` | Deploy metrics service |
...
| repoServer.metrics.enabled | bool | `true` | Deploy metrics service |
...
| server.metrics.enabled | bool | `true` | Deploy metrics service |
...
| dex.metrics.enabled | bool | `true` | Deploy metrics service |
...
| applicationSet.metrics.enabled | bool | `true` | Deploy metrics service |
...
| notifications.metrics.enabled | bool | `true` | Enables prometheus metrics server |
...
| notifications.metrics.serviceMonitor.enabled | bool | `false` | Enable a propmetheus ServiceMonitor |
